          ...
          <div className="template-example">
            ...
            <div className="row">
              <div className="col-md-6">
                ...
                <div className="row">
                  <div className="col-md-6">
                    <p><Link href="" className="btn btn-default btn-lg">Default Large</Link></p>
                    <p><Link href="" className="btn btn-default">Default </Link></p>
                    <p><Link href="" className="btn btn-default btn-sm">Default Small</Link></p>
                  </div>
                </div>
              ...
              <div className="col-md-6">
                ...
                <div className="row">
                  <div className="col-md-6">
                    <p><Link href="" className="btn btn-info btn-lg">Secondary Large</Link></p>
                    <p><Link href="" className="btn btn-info">Secondary </Link></p>
                    <p><Link href="" className="btn btn-info btn-sm">Secondary Small</Link></p>
                  </div>
                </div>
              </div>
            </div>
